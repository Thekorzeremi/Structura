 ...
 */
final class Version20250306024219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE worksite CHANGE manager_id manager_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE worksite CHANGE manager_id manager_id INT NOT NULL');
    }
}
