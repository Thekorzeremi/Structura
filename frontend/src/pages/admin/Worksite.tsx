          ...
          <div key={worksite.id} className="bg-white rounded-lg p-4 shadow-sm mb-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Location: {worksite.place}</p>
                <p className="text-gray-600">Start: {worksite.startDate}</p>
                <p className="text-gray-600">End: {worksite.endDate}</p>
              </div>
